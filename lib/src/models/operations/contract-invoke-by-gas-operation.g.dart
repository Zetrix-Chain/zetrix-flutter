...
part of 'contract-invoke-by-gas-operation.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ContractInvokeByGasOperation _$ContractInvokeByGasOperationFromJson(
        Map<String, dynamic> json) =>
    ContractInvokeByGasOperation(
      contractAddress: json['dest_address'] as String?,
      ztxAmount: (json['amount'] as num?)?.toInt(),
...
Map<String, dynamic> _$ContractInvokeByGasOperationToJson(
        ContractInvokeByGasOperation instance) =>
    <String, dynamic>{
