...
part of 'log-create-operation.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LogCreateOperation _$LogCreateOperationFromJson(Map<String, dynamic> json) =>
    LogCreateOperation(
      topic: json['topic'] as String?,
      datas:
          (json['datas'] as List<dynamic>?)?.map((e) => e as String).toList(),
    )
      ..operationType =
...
Map<String, dynamic> _$LogCreateOperationToJson(LogCreateOperation instance) =>
    <String, dynamic>{
